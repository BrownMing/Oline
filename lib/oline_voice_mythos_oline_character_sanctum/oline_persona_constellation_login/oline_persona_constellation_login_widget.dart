...
import 'oline_persona_constellation_login_model.dart';
export 'oline_persona_constellation_login_model.dart';

class OlinePersonaConstellationLoginWidget extends StatefulWidget {
  const OlinePersonaConstellationLoginWidget({super.key});

  static String routeName = 'OlinePersonaConstellation_login';
  static String routePath = '/olinePersonaConstellationLogin';

  @override
  State<OlinePersonaConstellationLoginWidget> createState() =>
      _OlinePersonaConstellationLoginWidgetState();
}

class _OlinePersonaConstellationLoginWidgetState
    extends State<OlinePersonaConstellationLoginWidget> {
  late OlinePersonaConstellationLoginModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OlinePersonaConstellationLoginModel());
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                context.pushNamed(
                                  OlineCosplayVoiceRealmSignupWidget.routeName,
                                  extra: <String, dynamic>{
                                    kTransitionInfoKey: TransitionInfo(
                                      hasTransition: true,
                                      transitionType:
