...
Widget wrapWithModel<T extends OlineRoleplayDialogueModel>({
  required T model,
...
T createModel<T extends OlineRoleplayDialogueModel>(
...
abstract class OlineRoleplayDialogueModel<W extends Widget> {
  ...
  OlineRoleplayDialogueModel setOnUpdate({
    bool updateOnChange = false,
...
class OlineRoleplayDialogueDynamicModels<T extends OlineRoleplayDialogueModel> {
  OlineRoleplayDialogueDynamicModels(this.defaultBuilder);
